...
describe("Type Proofs", () => {
	it('Prove types with "instanceof", "typeof", and "constructor" comparisons', () => {
		try {
			const typeProofs = [
				...
				{
					// @ts-ignore
					input: true.constructor === Boolean,
					output: true,
				},
				{
					// @ts-ignore
					input: true.constructor === Function,
					output: false,
				},
				{
					// @ts-ignore
					input: true.constructor === Object,
					output: false,
				},
				{
					// @ts-ignore
				...
				{
					// @ts-ignore
					input: false.constructor === Boolean,
					output: true,
				},
				{
					// @ts-ignore
					input: false.constructor === Function,
					output: false,
				},
				{
					// @ts-ignore
					input: false.constructor === Object,
					output: false,
				},
				{
